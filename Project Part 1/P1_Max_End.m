...
y = sqrt((F(1)/(5.1/100))^2 + (F(2)/(1.2/100))^2 ); 
% cost function: Crownin shield and Brand. 1981
% Computes for maximum endurance criterion. Does not predict co-activation
% adequately
